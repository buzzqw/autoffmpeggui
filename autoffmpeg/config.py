...
# Additional controls exposed by the guided panel.  They intentionally remain
# FFmpeg option names so the generated command can still be edited directly.
ENCODER_OPTION_CATALOG["x264"].update({
    "qp": "Constant quantizer", "b:v": "Target bitrate", "maxrate": "VBV maximum bitrate",
    "bufsize": "VBV buffer size", "fastfirstpass": "Fast first pass",
    "wpredp": "Weighted P prediction", "crf_max": "Maximum CRF quality",
    "psy": "Psychovisual optimizations", "weightb": "Weighted B prediction",
    "weightp": "Weighted P prediction", "b-bias": "B-frame bias",
    "b-pyramid": "B-frame pyramid", "mixed-refs": "Mixed references",
    "8x8dct": "8x8 transform", "fast-pskip": "Fast P-skip",
    "aud": "Access unit delimiters", "mbtree": "Macroblock tree",
    "cplxblur": "Ratecontrol curve blur", "partitions": "Analysis partitions",
    "direct-pred": "Direct motion prediction", "slice-max-size": "Slice size limit",
    "stats": "Two-pass statistics file", "nal-hrd": "HRD signaling",
    "motion-est": "Motion estimation", "forced-idr": "Force IDR frames",
    "coder": "Entropy coder", "b_strategy": "B-frame strategy",
    "chromaoffset": "Chroma QP offset", "sc_threshold": "Scene threshold",
    "noise_reduction": "Noise reduction", "x264-params": "Raw x264 parameters",
})
ENCODER_OPTION_SPECS["x264"].update({
    "qp": {"type": "int", "min": 0, "max": 51},
    "b:v": {"type": "int", "min": 0, "max": 1000000},
    "maxrate": {"type": "int", "min": 0, "max": 1000000},
    "bufsize": {"type": "int", "min": 0, "max": 1000000},
    "fastfirstpass": {"type": "bool", "ffmpeg_only": True}, "psy": {"type": "bool"},
    "weightb": {"type": "bool"}, "mixed-refs": {"type": "bool"},
    "8x8dct": {"type": "bool"}, "fast-pskip": {"type": "bool"},
    "aud": {"type": "bool"}, "mbtree": {"type": "bool"},
    "weightp": {"type": "choice", "choices": ["", "0", "1", "2"]},
    "b-pyramid": {"type": "choice", "choices": ["", "0", "1", "2"]},
    "partitions": {"type": "text"}, "direct-pred": {"type": "choice", "choices": ["", "0", "1", "2", "3"]},
    "coder": {"type": "choice", "choices": ["", "-1", "0", "1"]},
    "b_strategy": {"type": "int", "min": 0, "max": 2},
    "b-bias": {"type": "int", "min": -100, "max": 100},
    "cplxblur": {"type": "float", "min": 0, "max": 999},
    "slice-max-size": {"type": "int", "min": 0, "max": 10000000},
    "nal-hrd": {"type": "choice", "choices": ["", "0", "1", "2"]},
    "motion-est": {"type": "choice", "choices": ["", "0", "1", "2", "3", "4"]},
    "forced-idr": {"type": "bool"}, "chromaoffset": {"type": "int", "min": -51, "max": 51},
    "sc_threshold": {"type": "int", "min": -1, "max": 100},
    "noise_reduction": {"type": "int", "min": 0, "max": 100000,
                         "ffmpeg_only": True},
    "stats": {"type": "text", "ffmpeg_only": True},
    "x264-params": {"type": "text"},
})
ENCODER_OPTION_CATALOG["x265"].update({
    "qp": "Constant quantizer", "b:v": "Target bitrate", "maxrate": "VBV maximum bitrate",
    "bufsize": "VBV buffer size", "refs": "Reference frames", "g": "Maximum GOP length",
    "keyint_min": "Minimum GOP length", "sc_threshold": "Scene threshold",
    "rect": "Rectangular partitions", "amp": "Asymmetric partitions",
    "limit-refs": "Reference limiting", "limit-modes": "Mode limiting",
    "early-skip": "Early skip", "rskip": "Recursive skip", "rd": "RDO level",
    "rdoq-level": "RDO quantization", "b-intra": "Intra in B frames",
    "tu-intra-depth": "Intra TU depth", "tu-inter-depth": "Inter TU depth",
    "min-cu-size": "Minimum CU size", "frame-threads": "Frame threads",
    "wpp": "Wavefront parallel processing", "pmode": "Parallel mode decision",
    "pme": "Parallel motion estimation", "aq-mode": "AQ mode",
    "aq-strength": "AQ strength", "psy-rd": "Psycho-visual RDO",
    "psy-rdoq": "Psycho-visual RDOQ", "sao": "Sample adaptive offset",
    "deblock": "Deblocking filter", "qcomp": "Quantizer curve compression",
    "cutree": "CU-tree ratecontrol", "weightb": "Weighted B prediction",
    "weightp": "Weighted P prediction", "x265-params": "Raw x265 parameters",
})
ENCODER_OPTION_SPECS["x265"].update({
    "qp": {"type": "int", "min": 0, "max": 63},
    "b:v": {"type": "int", "min": 0, "max": 1000000},
    "maxrate": {"type": "int", "min": 0, "max": 1000000},
    "bufsize": {"type": "int", "min": 0, "max": 1000000},
    "refs": {"type": "int", "min": 1, "max": 16},
    "g": {"type": "int", "min": 0, "max": 100000},
    "keyint_min": {"type": "int", "min": 0, "max": 100000},
    "sc_threshold": {"type": "int", "min": 0, "max": 100},
    "rect": {"type": "bool"}, "amp": {"type": "bool"},
    "limit-refs": {"type": "choice", "choices": ["", "0", "1", "2", "3"]},
    "limit-modes": {"type": "bool"}, "early-skip": {"type": "bool"},
    "rskip": {"type": "choice", "choices": ["", "0", "1", "2"]},
    "rd": {"type": "int", "min": 1, "max": 6},
    "rdoq-level": {"type": "choice", "choices": ["", "0", "1", "2"]},
    "b-intra": {"type": "bool"}, "tu-intra-depth": {"type": "int", "min": 1, "max": 4},
    "tu-inter-depth": {"type": "int", "min": 1, "max": 4},
    "min-cu-size": {"type": "choice", "choices": ["", "8", "16", "32"]},
    "frame-threads": {"type": "int", "min": 0, "max": 16},
    "wpp": {"type": "bool"}, "pmode": {"type": "bool"}, "pme": {"type": "bool"},
    "cutree": {"type": "bool"}, "weightb": {"type": "bool"}, "weightp": {"type": "bool"},
    "psy-rdoq": {"type": "float", "min": 0, "max": 50},
    "x265-params": {"type": "text"},
    "x265-stats": {"type": "text", "ffmpeg_only": True},
})
ENCODER_OPTION_CATALOG["av1"].update({
    "qp": "Constant quantizer", "b:v": "Target bitrate", "maxrate": "VBV maximum bitrate",
    "bufsize": "VBV buffer size", "keyint": "Maximum GOP length", "g": "Maximum GOP length",
    "svtav1-params": "Raw SVT-AV1 parameters", "tile-columns": "Tile columns",
    "tile-rows": "Tile rows", "row-mt": "Row multithreading", "threads": "Thread count",
})
ENCODER_OPTION_SPECS["av1"].update({
    "qp": {"type": "int", "min": 0, "max": 63}, "b:v": {"type": "int", "min": 0, "max": 1000000},
    "maxrate": {"type": "int", "min": 0, "max": 1000000}, "bufsize": {"type": "int", "min": 0, "max": 1000000},
    "keyint": {"type": "int", "min": 0, "max": 100000}, "g": {"type": "int", "min": 0, "max": 100000},
    "tile-columns": {"type": "int", "min": 0, "max": 6}, "tile-rows": {"type": "int", "min": 0, "max": 6},
    "row-mt": {"type": "bool"}, "threads": {"type": "int", "min": 0, "max": 999},
})

ENCODER_OPTION_CATALOG["vp9"] = {
    "deadline": "Encoding deadline", "cpu-used": "Speed versus quality",
    "crf": "Constant quality", "b:v": "Target bitrate", "qmin": "Minimum quantizer",
    "qmax": "Maximum quantizer", "g": "Maximum GOP length", "aq-mode": "Adaptive quantization",
    "row-mt": "Row multithreading", "tile-columns": "Tile columns", "tile-rows": "Tile rows",
    "frame-parallel": "Frame parallel decoding", "lossless": "Lossless mode",
}
ENCODER_OPTION_SPECS["vp9"] = {
    "deadline": {"type": "choice", "choices": ["", "good", "best", "realtime"]},
    "cpu-used": {"type": "int", "min": 0, "max": 8}, "crf": {"type": "int", "min": 0, "max": 63},
    "b:v": {"type": "int", "min": 0, "max": 1000000}, "qmin": {"type": "int", "min": 0, "max": 63},
    "qmax": {"type": "int", "min": 0, "max": 63}, "g": {"type": "int", "min": 0, "max": 100000},
    "aq-mode": {"type": "int", "min": 0, "max": 4}, "row-mt": {"type": "bool"},
    "tile-columns": {"type": "int", "min": 0, "max": 6}, "tile-rows": {"type": "int", "min": 0, "max": 6},
    "frame-parallel": {"type": "bool"}, "lossless": {"type": "bool"},
}
ENCODER_OPTION_CATALOG.update({
    "xvid": {
        "qscale:v": "Constant quantizer", "b:v": "Target bitrate",
        "maxrate": "Maximum bitrate", "bufsize": "VBV buffer size",
        "g": "GOP length", "bf": "B-frames", "b_strategy": "B-frame strategy",
        "mbd": "Macroblock decision", "trellis": "Trellis quantization",
        "me_method": "Motion estimation", "dia_size": "Diamond search size",
        "qmin": "Minimum quantizer", "qmax": "Maximum quantizer",
        "vtag": "Video tag", "threads": "Thread count",
    },
    "mpeg4": {
        "qscale:v": "Constant quantizer", "b:v": "Target bitrate",
        "maxrate": "Maximum bitrate", "bufsize": "VBV buffer size",
        "g": "GOP length", "bf": "B-frames", "qmin": "Minimum quantizer",
        "qmax": "Maximum quantizer", "mbd": "Macroblock decision",
        "trellis": "Trellis quantization", "me_method": "Motion estimation",
    ...
    "mpeg2": {
        ...
        "maxrate": "Maximum bitrate", "bufsize": "VBV buffer size",
        "g": "GOP length", "bf": "B-frames", "qmin": "Minimum quantizer",
        "qmax": "Maximum quantizer", "dc": "Intra DC precision",
        "intra_vlc": "Intra VLC", "trellis": "Trellis quantization",
        "threads": "Thread count",
    },
    "prores": {
        "profile:v": "ProRes profile", "quant_mat": "Quantization matrix",
        "bits_per_mb": "Bits per macroblock", "mbs_per_slice": "Macroblocks per slice",
        "vendor": "Encoder vendor tag", "alpha_bits": "Alpha channel bits",
    },
    "dnxhd": {
        "profile:v": "DNxHR/DNxHD profile", "b:v": "Target bitrate",
        "mbd": "Macroblock decision", "threads": "Thread count",
    },
    "ffv1": {
        "level": "FFV1 version", "coder": "Entropy coder", "context": "Context model",
        "g": "GOP size", "slicecrc": "Slice CRC", "slices": "Slice count",
    },
    "wmv": {
        "qscale:v": "Constant quantizer", "b:v": "Target bitrate",
        "g": "GOP length", "bf": "B-frames", "qmin": "Minimum quantizer",
        "qmax": "Maximum quantizer", "threads": "Thread count",
    },
})
ENCODER_OPTION_SPECS.update({
    "xvid": {key: {"type": "text"} for key in ENCODER_OPTION_CATALOG["xvid"]},
    "mpeg4": {key: {"type": "text"} for key in ENCODER_OPTION_CATALOG["mpeg4"]},
    "mpeg2": {key: {"type": "text"} for key in ENCODER_OPTION_CATALOG["mpeg2"]},
    "prores": {key: {"type": "text"} for key in ENCODER_OPTION_CATALOG["prores"]},
    "dnxhd": {key: {"type": "text"} for key in ENCODER_OPTION_CATALOG["dnxhd"]},
    "ffv1": {key: {"type": "text"} for key in ENCODER_OPTION_CATALOG["ffv1"]},
    "wmv": {key: {"type": "text"} for key in ENCODER_OPTION_CATALOG["wmv"]},
})
